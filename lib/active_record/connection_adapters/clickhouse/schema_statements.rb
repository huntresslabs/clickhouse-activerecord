    ...
    module Clickhouse
      module SchemaStatements
        ...
        def internal_exec_query(sql, name = nil, binds = [], prepare: false, async: false, allow_retry: false)
          ...
          result = execute(sql, name, settings: { query_id: query_id })
        ...
        def new_column_from_field(table_name, field, _definitions)
          ...
          materialized = field.default_type == 'MATERIALIZED'
          ...
          default_function = materialized ? field.default_expression.presence : extract_default_function(field.default_expression)
